...
const ProductsGrid = () => {
  ...
  return (
    <>
      <section className="w-full grid md:grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] grid-cols-[repeat(auto-fit,_minmax(100px,_1fr))] gap-[2rem] md:px-[3.3rem] px-[1.5rem] pb-[8rem] md:pt-[3rem] bg-primary">
        {values.map((element) => (
          <div
